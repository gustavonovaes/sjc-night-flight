...
export const PLAYLIST_TEMPOS = [280, 280, 280, 280, 280, 280, 350, 310, 210, 180, 235, 185];
export const PLAYLIST_LABELS = [
  "Arcade", "Tetris", "Space Invaders", "Galaga", "Pac-Man", "Mario",
...
export const CTYPES_SCORE: CollectibleType[] = [
...
export const CTYPES_PW: CollectibleType[] = [
